...
public class AndyBitmap {
	...
	private AndyBitmap(Context context) {
		...
		configDiskCachePath(AndyBitmapUtil.getDiskCacheDir(context, "afinalCache").getAbsolutePath());//配置缓存路径
		configDisplayer(new AndySimpleDisplayer());//配置显示器
		configDownlader(new AndySimpleDownLoader());//配置下载器
	}
	...
	private AndyBitmap init(){
		...
		if( ! mInit ){
			...
			AndyBitmapCache.AndyImageCacheParams imageCacheParams = new AndyBitmapCache.AndyImageCacheParams(mConfig.cachePath);
			...
			//init BitmapProcess
			mBitmapProcess = new AndyBitmapProcess(mConfig.downloader,mImageCache);
			mInit = true ;
		}
...
/*****************************  andybitmap配置方法 end  ***************************************************/	
	...
	public void display(View imageView,String uri,int imageWidth,int imageHeight){
		AndyBitmapDisplayConfig displayConfig = configMap.get(imageWidth+"_"+imageHeight);
	...
	public void display(View imageView,String uri,Bitmap loadingBitmap){
		AndyBitmapDisplayConfig displayConfig = configMap.get(String.valueOf(loadingBitmap));
		if(displayConfig==null){
			displayConfig = getDisplayConfig();
	...
	public void display(View imageView,String uri,Bitmap loadingBitmap,Bitmap laodfailBitmap){
		AndyBitmapDisplayConfig displayConfig = configMap.get(String.valueOf(loadingBitmap)+"_"+String.valueOf(laodfailBitmap));
		if(displayConfig==null){
			displayConfig = getDisplayConfig();
			displayConfig.setLoadingBitmap(loadingBitmap);
	...
	public void display(View imageView,String uri,int imageWidth,int imageHeight,Bitmap loadingBitmap,Bitmap laodfailBitmap){
		AndyBitmapDisplayConfig displayConfig = configMap.get(imageWidth+"_"+imageHeight+"_"+String.valueOf(loadingBitmap)+"_"+String.valueOf(laodfailBitmap));
		if(displayConfig==null){
			displayConfig = getDisplayConfig();
			displayConfig.setBitmapHeight(imageHeight);
			displayConfig.setBitmapWidth(imageWidth);
	...
	public Bitmap getBitmapFromDiskCache(String key, AndyBitmapDisplayConfig config){
...
/******************************** private method start ******************************************/	
	public void display(View imageView,String uri, AndyBitmapDisplayConfig config){
...
/******************************** 内部类 start ******************************************/	
	 ...
	 * @author michael yang
	 */
	private class BitmapLoadAndDisplayTask extends AndyAsyncTask<Object, Void, Bitmap> {
		private Object data;
		private final WeakReference<View> imageViewReference;
		private final AndyBitmapDisplayConfig displayConfig;
	
		public BitmapLoadAndDisplayTask(View imageView, AndyBitmapDisplayConfig config) {
	...
	private class AndyBitmapConfig {
		public String cachePath;
		 public AndyDisplayer displayer;
		 public AndyDownLoader downloader;
		 public AndyBitmapDisplayConfig defaultDisplayConfig;
		 ...
		 public AndyBitmapConfig(Context context) {
				...
				defaultDisplayConfig.setAnimationType(AndyBitmapDisplayConfig.AnimationType.fadeIn);

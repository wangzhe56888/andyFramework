...
public class AndyPreferencesCookieStore implements CookieStore {
	...
	public AndyPreferencesCookieStore(Context context) {
		...
		if (cookieNameString != null) {
			String[] cookieNames = TextUtils.split(cookieNameString,
					COOKIE_SPLIT);
	...
	public void addCookie(Cookie cookie) {
		...
		editor.putString(COOKIE_NAME_STORE,
				TextUtils.join(COOKIE_SPLIT, cookies.keySet()));
		editor.putString(COOKIE_NAME_PREFIX + name,
				encodeCookie(new AndySerializableCookie(cookie)));
		editor.commit();
	}

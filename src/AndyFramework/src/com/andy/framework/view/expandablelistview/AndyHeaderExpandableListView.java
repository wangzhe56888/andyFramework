...
/**
 * @description: group滚动最顶端显示
 * @author: andy  
 * @mail: win58@qq.com
 * @date: 2015-7-29  下午5:49:47
 */
@SuppressLint("ClickableViewAccessibility")
public class AndyHeaderExpandableListView extends ExpandableListView
		implements OnScrollListener, OnGroupClickListener {

	public AndyHeaderExpandableListView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		registerListener();
	}

	public AndyHeaderExpandableListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		registerListener();
	}

	public AndyHeaderExpandableListView(Context context) {
		super(context);
		registerListener();
	}
	...
	private AndyHeaderExpLVAdapter mAdapter;
	...
	public void setAdapter(ExpandableListAdapter adapter) {
		...
		mAdapter = (AndyHeaderExpLVAdapter) adapter;
	}
	...
	public void configureHeaderView(int groupPosition, int childPosition) {
		...
		switch (state) {
			case AndyHeaderExpLVAdapter.ANDY_EXPANDABLE_HEADER_GONE: {
				mHeaderViewVisible = false;
				break;
			}
	
			case AndyHeaderExpLVAdapter.ANDY_EXPANDABLE_HEADER_VISIBLE: {
			...
			case AndyHeaderExpLVAdapter.ANDY_EXPANDABLE_HEADER_PUSHED_UP: {

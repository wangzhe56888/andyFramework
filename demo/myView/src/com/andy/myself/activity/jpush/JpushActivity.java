...
public class JpushActivity extends JPushBaseHeaderActivity {
	...
	public void onClick(View v) {
		...
		case R.id.init:
			...
			break;
		case R.id.setting:
			Intent intent = new Intent(JpushActivity.this, PushSetActivity.class);
	...
	public static final String MESSAGE_RECEIVED_ACTION = "com.andy.myself.MESSAGE_RECEIVED_ACTION";
